...
export default function AdminDashboard() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#edf1ff,#f6f8fc_48%,#f3f6fb)] text-[#141414]">
      <div className="mx-auto max-w-[1400px] px-4 py-6 sm:px-6">
        <header className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <div>
            <p className="text-sm font-medium text-[#4f5ae0]">Admin Dashboard</p>
            <h1 className="text-4xl font-semibold tracking-tight">Katseye Insights</h1>
            <p className="mt-1 text-xs text-neutral-500">Last save: {lastSaved}</p>
          </div>
          <div className="flex items-center gap-2">
            <button className="rounded-xl border border-neutral-300 bg-white px-4 py-2 text-sm font-medium">
              Export Report
            </button>
            <button
              type="button"
              className="rounded-xl bg-[#272b74] px-4 py-2 text-sm font-medium text-white"
              onClick={saveChanges}
            >
              Save Changes
            </button>
        ...
        <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
          ...
          <article className="rounded-2xl bg-[linear-gradient(135deg,#4a4bb6,#3a8bd8)] p-4 text-white shadow-sm">
        ...
        <section className="mt-6 grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
                    ...
                    <tr key={item.id} className="border-b border-neutral-100">
                      ...
                      <td className="py-3">
                        <input
                          ...
                          className="h-9 w-20 rounded-lg border border-neutral-300 px-2"
                        />
                      </td>
                      <td className="py-3">
          ...
          <article className="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-black/5">
            ...
            <div className="flex h-56 items-end gap-2 rounded-xl bg-[#f8f9fe] p-3">
          ...
          <article className="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-black/5">
            ...
            <div className="space-y-3">
              {topItems.map((item, index) => (
                <div key={item.name} className="flex items-center justify-between rounded-xl bg-[#f6f7fc] px-3 py-2">
